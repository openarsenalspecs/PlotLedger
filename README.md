...
- PlotLedger specifications are free to use with attribution. A Specification Branding License can be negotiated upon request. [https://roxanneardary.com/plotledger/](https://roxanneardary.com/plotledger/)  
